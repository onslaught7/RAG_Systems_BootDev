...
def main() -> None:
    ...
    bm25search_parser.add_argument("limit", type=int, nargs='?', default=5, help="Get the top N results.")
    ...
    match args.command:
        ...
        case "bm25search":
            idx = InvertedIndex()
            idx.load()
            idx.bm25_search(args.query, args.limit)
            print(f"Top {args.limit} search results for {args.query}")
        case _:
            parser.print_help()
